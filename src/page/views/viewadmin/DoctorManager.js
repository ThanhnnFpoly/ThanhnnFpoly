        ...
        <Row>
          ...
          <Col className="">
            ...
            <button
              ...
              <h3 className="text-center"><b> Thêm bác sĩ mới</b> </h3>
                <div className="modal-body" md="6">
                <p className="text-info"> <b>Tên bác sĩ: </b></p>
                    ...
                    <Input placeholder="Username"  type="select">
                      <option><p>Nam</p></option>
                      <option><p>Nữ</p></option>
                      </Input>
                    <br/>
                    <p className="text-info"> <b>Loại bệnh: </b></p>
                    <Input placeholder="Username"  type="select">
                      <option><p>Sốt</p></option>
                      <option><p>Ho</p></option>
                      </Input>
                    <br/>
