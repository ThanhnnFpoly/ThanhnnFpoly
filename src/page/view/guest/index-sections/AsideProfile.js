...
function AsideProfile(){
  ...
  <div className="section">
      <Col md ="12">
          <h2 style={{color:"black",fontVariant:"small-caps"}}> Bác sĩ chuyên khoa II Trần Thị Hoài Hương</h2>
...
Bác sĩ Hương có hơn 20 năm kinh nghiệm trong khám và điều trị bệnh lý da liễu
          ...
          <h2 stype={{color:"black",fontVariant:"small-caps",fontFamily:"Georgia"}}> Quá trình công tác</h2>
      <p className="description">
          ...
          <h2 stype={{color:"black",fontVariant:"small-caps",fontFamily:"Georgia"}}> Quá trình đào tạo</h2>
      <p className="description">
                The kit comes with three pre-built pages to help you get started
                faster. You can change the text and images and you're good to
                go. More importantly, looking at them will give you a picture of
              ...
              <h2 stype={{color:"black",fontVariant:"small-caps",fontFamily:"Georgia"}}> Khám và điều trị</h2>
              <br/>
              <h3 stype={{color:"black",fontVariant:"small-caps",fontFamily:"Georgia"}}>Bác sĩ khám và điều trị:</h3>
      <p className="description">
